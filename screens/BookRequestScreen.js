    ...
    if(this.state.IsBookRequestActive === true){
      return(
        ...
        <View style = {{flex:1,justifyContent:'center'}}>
          <View style={{borderColor:"#00FFFF",borderWidth:2,justifyContent:'center',alignItems:'center',padding:10,margin:10}}>
          <Text>Book Name</Text>
          ...
          <TouchableOpacity style={{borderWidth:1,borderColor:'#00FFFF',backgroundColor:"#00FFFF",width:300,alignSelf:'center',alignItems:'center',height:30,marginTop:30}}
          onPress={()=>{
